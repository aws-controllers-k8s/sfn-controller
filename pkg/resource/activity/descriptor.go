...
const (
	FinalizerString = "finalizers.sfn.services.k8s.aws/Activity"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("activities")
