...
const (
	finalizerString = "finalizers.sfn.services.k8s.aws/StateMachine"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("statemachines")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.StateMachine{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.StateMachine),
	}
}
