...
const (
	FinalizerString = "finalizers.sfn.services.k8s.aws/StateMachineAlias"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("statemachinealiases")
	GroupKind            = metav1.GroupKind{
		Group: "sfn.services.k8s.aws",
		Kind:  "StateMachineAlias",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.StateMachineAlias{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.StateMachineAlias),
	}
}
