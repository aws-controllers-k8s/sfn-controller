...
var (
	...
	_ = strings.ToLower("")
	_ = &svcsdk.Client{}
	_ = &svcapitypes.StateMachineAlias{}
...
func (rm *resourceManager) sdkFind(
	...
	var resp *svcsdk.DescribeStateMachineAliasOutput
	resp, err = rm.sdkapi.DescribeStateMachineAlias(ctx, input)
	...
	if resp.RoutingConfiguration != nil {
		f3 := []*svcapitypes.RoutingConfigurationListItem{}
		for _, f3iter := range resp.RoutingConfiguration {
			f3elem := &svcapitypes.RoutingConfigurationListItem{}
			if f3iter.StateMachineVersionArn != nil {
				f3elem.StateMachineVersionARN = f3iter.StateMachineVersionArn
			}
			weightCopy := int64(f3iter.Weight)
			f3elem.Weight = &weightCopy
			f3 = append(f3, f3elem)
		}
		ko.Spec.RoutingConfiguration = f3
	} else {
		ko.Spec.RoutingConfiguration = nil
	}
	if ko.Status.ACKResourceMetadata == nil {
		ko.Status.ACKResourceMetadata = &ackv1alpha1.ResourceMetadata{}
	}
	if resp.StateMachineAliasArn != nil {
		arn := ackv1alpha1.AWSResourceName(*resp.StateMachineAliasArn)
...
func (rm *resourceManager) newDescribeRequestPayload(
	r *resource,
) (*svcsdk.DescribeStateMachineAliasInput, error) {
	res := &svcsdk.DescribeStateMachineAliasInput{}
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.CreateStateMachineAliasInput, error) {
	res := &svcsdk.CreateStateMachineAliasInput{}
	...
	if r.ko.Spec.RoutingConfiguration != nil {
		f2 := []svcsdktypes.RoutingConfigurationListItem{}
		for _, f2iter := range r.ko.Spec.RoutingConfiguration {
			f2elem := &svcsdktypes.RoutingConfigurationListItem{}
			if f2iter.StateMachineVersionARN != nil {
				f2elem.StateMachineVersionArn = f2iter.StateMachineVersionARN
			}
			if f2iter.Weight != nil {
				weightCopy0 := *f2iter.Weight
				...
				f2elem.Weight = weightCopy
			}
			f2 = append(f2, *f2elem)
		}
		res.RoutingConfiguration = f2
	}
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DeleteStateMachineAliasInput, error) {
	res := &svcsdk.DeleteStateMachineAliasInput{}
