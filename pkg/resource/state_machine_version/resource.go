...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	r.ko.Spec.StateMachineARN = &identifier.NameOrID
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	primaryKey, ok := fields["stateMachineARN"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: stateMachineARN"))
	}
	r.ko.Spec.StateMachineARN = &primaryKey
